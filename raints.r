...
rainfall.albany.overview <- read_csv(
  ...
  complete(
    date = seq.Date(
      lubridate::as_date(sprintf(
        "%04d-%01d-%01d", start.year, start.month, 1
      )),
      lubridate::as_date(
        sprintf(
          "%04d-%01d-%01d",
          ...
          lubridate::days_in_month(end.month)
        )
      ),
      by = "day"
    ),
    fill = list(rainfall = 0.0)
  ) %>%
  mutate(
  ...
  filter(date >= lubridate::as_date(sprintf(
    "%04d-%01d-%01d", start.year, start.month, 1
  )) &
...
boxplot(
  rainfall ~ station,
  data = rainfall.weekly.overview,
  xlab = "",
  ylab = "",
  ylim = c(0, 90),
  at = c(1, 2),
  col = grey.colors(2, start = 0.5, alpha = 0.5),
  names = c("Albany", "Cape Nat."),
  horizontal = TRUE
)
title(
  main = "",
...
hist(
  rainfall.weekly.overview$rainfall[rainfall.weekly.overview$station == 009500],
  breaks = 20,
  main = "",
  xlab = "",
  ylab = "",
...
hist(
  rainfall.weekly.overview$rainfall[rainfall.weekly.overview$station == 009519],
  breaks = 20,
  main = "",
  xlab = "",
  ylab = "",
...
plot(
  density(rainfall.weekly.overview$rainfall[rainfall.weekly.overview$station == 009500]),
  main = "",
  xlab = "",
  ylab = "",
  xlim = c(0, 90),
...
lines(
  density(rainfall.weekly.overview$rainfall[rainfall.weekly.overview$station == 009519]),
  main = "",
  xlab = "",
  ylab = "",
  xlim = c(0, 90),
...
title(
  main = "Weekly Rainfall in Albany (009500)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
acf(
  rainfall.albany.weekly$rainfall,
  lag.max = nrow(rainfall.albany.weekly),
  ylab = "",
  main = ""
)
...
rainfall.albany.weekly.sm <-
  smooth.sym(rainfall.albany.weekly$rainfall, 7)
...
title(
  main = "Smoothed Weekly Rainfall in Albany (009500)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Smoothed (Spencer's 15-point MA) Weekly Rainfall in Albany (009500)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Weekly Rainfall in Cape Naturaliste (009519)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
acf(
  rainfall.capenaturaliste.weekly$rainfall,
  lag.max = nrow(rainfall.capenaturaliste.weekly),
  ylab = "",
  main = ""
)
title(xlab = "Lag", ylab = "ACF", line = 2)
...
rainfall.capenaturaliste.weekly.sm <-
  smooth.sym(rainfall.capenaturaliste.weekly$rainfall, 7)
...
title(
  main = "Smoothed Weekly Rainfall in Cape Naturaliste (009519)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Smoothed (Spencer's 15-point MA) Weekly Rainfall in Cape Naturaliste (009519)",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Weekly Rainfall in Albany (009500) Differenced at Lag 1",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
acf(
  rainfall.albany.weekly.diff,
  lag.max = length(rainfall.albany.weekly.diff),
  ylab = "",
  main = ""
)
title(xlab = "Lag", ylab = "ACF", line = 2)
...
title(
  main = "Weekly Rainfall in Cape Naturaliste (009519) Differenced at Lag 1",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
acf(
  rainfall.capenaturaliste.weekly.diff,
  lag.max = length(rainfall.capenaturaliste.weekly.diff),
  ylab = "",
  main = ""
)
title(xlab = "Lag", ylab = "ACF", line = 2)
...
hist(
  rainfall.capenaturaliste.weekly.model$residuals,
  breaks = 10,
  main = "",
  xlab = "",
  ylab = ""
...
title(
  main = "Forecasts for Albany (009500) with h = m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Forecasts for Albany (009500) with h = 2m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Forecasts for Albany (009500) with h = 4m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Forecasts for Cape Naturaliste (009519) with h = m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Forecasts for Cape Naturaliste (009519) with h = 2m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
...
title(
  main = "Forecasts for Cape Naturaliste (009519) with h = 4m",
  xlab = "",
  ylab = "Rainfall (mm)",
  line = 2
)
